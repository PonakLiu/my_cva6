...
# DVE full session
# Saved on Fri Apr 14 11:29:12 2023
# Designs open: 1
#   Sim: /home/z/code/my_cva6/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: cva6_config_pkg
#   Schematic.1: .
#   Schematic.2: cva6.commit_stage_i
#   Schematic.3: cva6.i_frontend
#   Group count = 0
...
#<Session mode="Full" path="/home/z/code/my_cva6/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{58 64} {1919 1079}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 174} {height 908} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 174} {height 908} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
if { ![gui_is_db_opened -db {/home/z/code/my_cva6/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /home/z/code/my_cva6 -nosource
}
}
...
catch {gui_list_select -id ${Hier.1} {cva6}}
...
gui_list_show_data -id ${Data.1} {cva6}
...
gui_open_source -id ${Source.1}  -replace -active cva6_config_pkg /home/z/code/my_cva6/core/include/cv32a6_ima_sv32_fpga_config_pkg.sv
...
gui_path_show -window ${Schematic.1} -objects {cva6.clk_i cva6.rst_ni cva6.boot_addr_i cva6.hart_id_i cva6.irq_i cva6.ipi_i cva6.time_irq_i cva6.debug_req_i cva6.cvxif_req_o cva6.cvxif_resp_i cva6.axi_req_o cva6.axi_resp_i}
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.1}]
gui_zoom -window ${Schematic.1} -rect { {-56452 -51862} {65624 3732} }
...
gui_sch_show -window ${Schematic.2} -name cva6.commit_stage_i
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.2}]
gui_zoom -window ${Schematic.2} -rect { {-87210 -113066} {172406 5162} }
...
gui_sch_show -window ${Schematic.3} -name cva6.i_frontend
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.3}]
gui_zoom -window ${Schematic.3} -rect { {-17348 -245519} {418893 5518} }
...
if {[gui_exist_window -window ${TopLevel.1}]} {
	...
	gui_set_active_window -window ${Schematic.3}
}
#</Session>
